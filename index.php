      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <!--   <a href="index.html"> <span class="fa fa-shopping-cart"></span>
              <p>Shop<strong>Zilla</strong> <span>Shop With Us</span></p> -->
              </a> 
              <!-- img based logo --> 
              <a href="index.html"><img src="img/logo.jpg" alt="logo img" width="300" height="100"></a> 
            </div>
            <!-- / logo  --> 
  ...
  <div class="aa-slider-area">
    <div id="sequence" class="seq">
      <ul class="seq-canvas">
        <!-- single slide item -->
        <li>
          <div class="seq-model"> <img data-seq src="img/slider/slider-1.jpg" alt="Men slide img" height="500"/> </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <p><span class="fa fa-envelope"></span>shopzilla@gmail.com</p>
                    </address>
